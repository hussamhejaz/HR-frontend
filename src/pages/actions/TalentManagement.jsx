  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-slate-50 via-white to-white p-6 md:p-10">
      <div className="mx-auto flex max-w-5xl flex-col gap-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-lime-500 via-green-500 to-emerald-500 p-8 text-white shadow-xl">
          ...
          <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-white/80">
                {t("actionPages.talent.badge")}
              </p>
              <h1 className="mt-2 text-3xl font-semibold leading-tight md:text-4xl">
                {t("actionPages.talent.title")}
              </h1>
              <p className="mt-3 max-w-2xl text-base text-emerald-50/90">
                {t("actionPages.talent.subtitle")}
              </p>
            </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <InfoCard
            icon={FiStar}
            title={t("actionPages.talent.cards.successions.title")}
            desc={t("actionPages.talent.cards.successions.desc")}
          />
          <InfoCard
            icon={FiTarget}
            title={t("actionPages.talent.cards.performance.title")}
            desc={t("actionPages.talent.cards.performance.desc")}
          />
        </div>
      </div>
    </div>
